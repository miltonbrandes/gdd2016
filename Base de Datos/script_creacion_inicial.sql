...
as
	begin
		 select top 5 profesional_matricula, profesional_nombre, profesional_apellido
...
--		Funca  -> verificar grupo familiar
 ...
 as
	Begin
		select top 5 afil1.afiliado_nro, afil1.afiliado_nombre, afil1.afiliado_apellido,
