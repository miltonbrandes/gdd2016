                    ...
                    if (chk_fecha.Checked == true)
                    {
                        if (chk_horario.Checked == true)
                        {
                            if (hora1.Text != string.Empty && hora2.Text != string.Empty && minuto1.Text != string.Empty && minuto2.Text != string.Empty)
                            {
                                ...
                                DateTime dInicio = new DateTime(ConfigTime.getFechaSinHora().Year, 1, 1, Int32.Parse(hora1.Text), Int32.Parse(minuto1.Text), 0);
                                TimeSpan tInicio = dInicio.TimeOfDay;
                                DateTime dFin = new DateTime(ConfigTime.getFechaSinHora().Year, 1, 1, Int32.Parse(hora2.Text), Int32.Parse(minuto2.Text), 0);
